...
function addTimesheet(intent, session, callback) {
    ...
    if (projectSlot && typeof(projectSlot.value) !== 'undefined') {
        ...
        speechOutput = categorySlot && typeof(categorySlot.value) !== 'undefined' ? `Got it. Adding new timesheet to ${project} project, ${category} category for Abhilash Pedamallu.` : `Got it. Adding new timesheet to ${project} project for Abhilash Pedamallu.`;
    } else {
